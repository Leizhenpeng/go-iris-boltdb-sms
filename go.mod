module leizhenpeng/go-iris-boltdb-sms
...
require (
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/common v1.0.580
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/sms v1.0.580
